...
@endif
<form role="form" id="form_komoditas" action="" method="post">
    {!! csrf_field() !!}
    <div class="form-body">
        ...
        <div class="form-group form-md-line-input form-md-floating-label">
            <input type="text" class="form-control" id="form_control_1" name="nama_komoditas" value="{{ $model->nama_komoditas }}">
            <label for="form_control_1">Nama Komoditas</label>
        </div>
    </div>
    <div class="form-actions noborder">
        <button type="submit" class="btn blue">Submit</button>
        <a href="{{ url('/operator/komoditas') }}" class="btn default">Cancel</a>
    </div>
</form>

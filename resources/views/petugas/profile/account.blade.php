...
@section('page_title')
    {!! Helper::pageTitle('Profile','Profile Petugas') !!}
@endsection

@section('breadcrumb')
    <li>
        <a href="{{ url('/petugas/profile') }}">Profile</a>
            ...
            <div class="profile-sidebar">
                ...
                <div class="portlet light profile-sidebar-portlet bordered">
                    ...
                    <div class="profile-usertitle">
                        ...
                        <div class="profile-usertitle-job"> Petugas </div>
                    </div>
                            ...
                            <div class="portlet-body">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="tab_1_1">
                                        <form role="form" action="{{ url('/petugas/profile/overview') }}" method="post" id="overview">
                                            <div>
                                    ...
                                    <div class="tab-pane" id="tab_1_2">
                                        <form role="form" action="{{ url('/petugas/profile/avatar') }}" method="post" id="avatar" enctype="multipart/form-data">
                                            <div>
                                                <div class="alert alert-danger display-hide">
                                                    <button class="close" data-close="alert"></button>
                                                    You have some form errors. Please check below.
                                    ...
                                    <div class="tab-pane" id="tab_1_3">
                                        <form role="form" action="{{ url('/petugas/profile/password') }}" method="post" id="frm_password">
                                            <div>
                                                <div class="alert alert-danger display-hide">
                                                    <button class="close" data-close="alert"></button>
                                                    You have some form errors. Please check below.

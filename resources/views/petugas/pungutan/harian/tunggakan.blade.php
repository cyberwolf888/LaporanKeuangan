...
@section('page_title')
    <h1>Pungutan
        <small>Create data tunggakan harian</small>
    </h1>
@endsection

@section('breadcrumb')
    <li>
        <a href="{{ url('/petugas/pungutan/harian') }}">Tunggakan Harian</a>
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject bold uppercase">Add New Data Tunggakan Harian</span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body form">
                    <div class="row">
                        @if($dagang)
                            @include('petugas.pungutan.harian.form_tunggakan')
                        @else
                            @include('petugas.pungutan.harian.form_date')
                        @endif
                    </div>
                </div>
            </div>

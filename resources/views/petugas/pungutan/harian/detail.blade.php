...
@section('page_title')
    <h1>Pungutan
        <small>Detail pungutan harian</small>
    </h1>
@endsection

@section('breadcrumb')
    <li>
        <a href="{{ url('/petugas/pungutan/harian') }}">Pungutan Harian</a>
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject bold uppercase">Detail Pungutan Harian</span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body form">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group form-md-line-input">
                                    {!! Form::text('tempat_berjualan', Helper::formatMoney($model->harian->tempat_berjualan), ['class' => 'form-control', 'id'=>'tempat_berjualan', 'disabled']) !!}
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-md-line-input">
                                    {!! Form::text('listrik', Helper::formatMoney($model->harian->listrik), ['class' => 'form-control', 'id'=>'listrik', 'disabled']) !!}
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group form-md-line-input">
                                    {!! Form::text('air', Helper::formatMoney($model->harian->air), ['class' => 'form-control', 'id'=>'air', 'disabled']) !!}
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-md-line-input">
                                    {!! Form::text('jumlah', Helper::formatMoney($model->harian->jumlah), ['class' => 'form-control', 'id'=>'jumlah', 'min'=>0, 'disabled']) !!}
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group form-md-line-input">
                                    {!! Form::text('ppn', Helper::formatMoney($model->harian->ppn), ['class' => 'form-control', 'id'=>'ppn', 'min'=>0, 'disabled']) !!}
                                    {!! Form::Label('ppn', 'PPN 10%') !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-md-line-input">
                                    {!! Form::text('total', Helper::formatMoney($model->harian->total), ['class' => 'form-control', 'id'=>'total', 'min'=>0, 'disabled']) !!}

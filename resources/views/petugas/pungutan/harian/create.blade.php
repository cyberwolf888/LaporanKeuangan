...
@section('page_title')
    <h1>Pungutan
        <small>Create data pungutan harian</small>
    </h1>
@endsection
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject bold uppercase">Add New Data Pungutan Harian</span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body form">
                    <div class="row">
                        @include('petugas.pungutan.harian.form')
                    </div>
                </div>
            </div>
            <!-- END Portlet PORTLET-->

...
class LaporanController extends Controller
{
    ...
    public function indexKeuangan(Request $request)
    {
        if(count($request->all())>0){
            return redirect()->route('laporan.resultKeuanganDirut',[
        ...
        return view('dirut.laporan.keuangan.form_date',['pasar'=>$pasar]);
    }
    ...
    public function resultKeuangan($start_date, $end_date, $pasar, $sts_pungutan)
    {
        ...
        return view('dirut.laporan.keuangan.result',[
            'total'=>$total,
            'detail'=>$detail,
    ...
    public function indexDagang(Request $request)
    {
        if(count($request->all())>0){
            ...
            return redirect()->route('laporan.resultDagangDirut',[
                'start_date'=>$request->start_date,
                'end_date'=>$request->end_date,
                'pasar'=>$request->id_pasar,
        ...
        return view('dirut.laporan.dagang.form_date',['pasar'=>$pasar, 'komoditas'=>$komoditas]);
    }
    public function resultDagang($start_date, $end_date, $pasar, $komoditas, $sts_dagang)
    {
        ...
        return view('dirut.laporan.dagang.result',[
            'detail'=>$detail,
            'start_date'=>$start_date,
            'end_date'=>$end_date
        ]);
